...
import com.rizastar.solringopie.tracking.benefits.BenefitList;
import com.rizastar.solringopie.utils.BenefitsParser;
import com.rizastar.solringopie.utils.ComplexityParser;
...
public class ConfigHandler {
    ...
    public static void onServerStart(ServerStartingEvent event) {
        complexityMap = ComplexityParser.parse(SOLRingoPieConfig.getComplexityUnparsed());
        thresholds = SOLRingoPieConfig.getThresholds();
        List<List<Benefit>> benefits = BenefitsParser.parse(SOLRingoPieConfig.getBenefitsUnparsed());

package com.rizastar.solringopie.tracking.benefits;
...
import com.rizastar.solringopie.tracking.CapabilityHandler;
...
public class BenefitsHandler {
    ...
    public static void updateBenefits(Player player, double diversity) {
        ...
        if (foodList.getFoodsEaten() < SOLRingoPieConfig.minFoodsToActivate()) {
            return;
        }
    ...
    public static boolean checkEvent(LivingEvent event) {
        ...
        return !SOLRingoPieConfig.limitProgressionToSurvival() || isInSurvival;
    }

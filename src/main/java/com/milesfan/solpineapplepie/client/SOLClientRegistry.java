...
import com.milesfan.solpineapplepie.lib.Localization;
...
@Mod.EventBusSubscriber(modid = SOLPineapplePie.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)

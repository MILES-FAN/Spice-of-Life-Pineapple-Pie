package com.milesfan.solpineapplepie.lib;
...
public final class Localization {
	...
	/** e.g. keyString("tooltip", "eaten_status.not_eaten_1") -> "tooltip.solpineapplepie.eatenStatus.not_eaten_1") */
	public static String keyString(String domain, String path) {
		return domain + "." + SOLPineapplePie.MOD_ID + "." + path;
	}

...
import com.milesfan.solpineapplepie.tracking.benefits.BenefitList;
import com.milesfan.solpineapplepie.utils.BenefitsParser;
import com.milesfan.solpineapplepie.utils.ComplexityParser;
...
public class ConfigHandler {
    ...
    public static void onServerStart(ServerStartingEvent event) {
        complexityMap = ComplexityParser.parse(SOLPineapplePieConfig.getComplexityUnparsed());
        thresholds = SOLPineapplePieConfig.getThresholds();
        List<List<Benefit>> benefits = BenefitsParser.parse(SOLPineapplePieConfig.getBenefitsUnparsed());
